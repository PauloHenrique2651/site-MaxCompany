      ...
      _cornerActivated: function (a) {
        ...
        switch (b.effect) {
          case "hard":
            ...
            break;
          case "sheet":
            // Somente os quatro cantos ativam o efeito de
            // "orelha"/dobra. Isso preserva o comportamento
            // original do Turn.js, inclusive o arrasto responsivo.
            if (a.x <= e && a.y <= e) a.corner = "tl";
            else if (a.x >= c - e && a.y <= e) a.corner = "tr";
            else if (a.x <= e && a.y >= d - e) a.corner = "bl";
            else if (a.x >= c - e && a.y >= d - e) a.corner = "br";
            else return !1;
        }
